...
exports.getFullCalender = exports.getWeekend = exports.getLastDayOfMonth = exports.getFirstDayOfMonth = void 0;
/**
 * 获取当月第一天
 * @param date
 * @returns 当月第一天的日期
 ...
 */
const getFullCalender = (date) => {
    // TODO 校验入参
    // 处理跨年,1月和12月涉及到跨年
    const firstDay = (0, exports.getFirstDayOfMonth)(date);
    const lastDay = (0, exports.getLastDayOfMonth)(date);
    ...
    for (let i = 0; i < startCompleteDays; i++) {
        ...
        const lastDayInPreMonth = (0, exports.getLastDayOfMonth)(new Date(thisYear, preMonth, 1));
...
exports.getFullCalender = getFullCalender;
